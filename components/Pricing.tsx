    ...
    <section className="py-24 relative overflow-hidden" id="pricing">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto items-center">
          ...
          >
            <h3 className="text-xl font-bold text-gray-300 mb-2">Standard Tarif</h3>
            <div className="text-4xl font-bold text-white mb-2">CHF 499<span className="text-sm text-gray-500 font-normal">/Monat</span></div>
            <p className="text-sm text-gray-500 mb-6">Regulärer Preis ohne Aktion</p>
            
            <ul className="space-y-3 mb-8 w-full text-left">
               <li className="flex items-center gap-3 text-gray-400 text-sm"><Check size={16} className="text-gray-600" /> AI Voice Agent</li>
               <li className="flex items-center gap-3 text-gray-400 text-sm"><Check size={16} className="text-gray-600" /> Terminbuchung</li>
               <li className="flex items-center gap-3 text-gray-400 text-sm"><Check size={16} className="text-gray-600" /> Schweizer Nummer</li>
            </ul>
             <Button variant="outline" className="w-full grayscale" disabled>Derzeit nur Standard</Button>
          </motion.div>

          {/* Flash Offer - Main Focus */}
          <motion.div 
          ...
          >
            <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-accent text-black font-bold px-6 py-2 rounded-full text-sm shadow-lg shadow-accent/40 whitespace-nowrap flex items-center gap-2">
              <Zap size={16} fill="currentColor" /> FALSH DEAL
            </div>

            <div className="flex justify-between items-start mb-6 pt-4">
                <div className="text-left">
                  <h3 className="text-2xl font-bold text-white flex items-center gap-2">
                    AIDevelo Pro <Star size={16} className="text-yellow-400 fill-yellow-400" />
                  </h3>
            ...
            <div className="mb-6 p-4 bg-white/5 rounded-xl border border-white/10 text-left">
                <div className="text-sm text-gray-400 mb-1">Komplettpreis für 3 Monate:</div>
                <div className="flex items-center gap-3">
                    <span className="text-5xl font-bold text-white">CHF 599</span>
                    <div className="flex flex-col text-left">
                        <span className="text-sm text-gray-500 line-through">statt CHF 1'497</span>
            ...
            <ul className="space-y-4 mb-8 flex-1 text-left">
              ...
              {[
                  'Volle 24/7 Erreichbarkeit', 
                  'Unlimitierte Anrufe & Kunden', 
                  'Voice Cloning (Ihre Stimme)', 
                  'Setup & Training in 24h inkl.',
                  'WhatsApp & SMS Follow-ups',
                  'Nach 3 Monaten: Dauerhaft 50% Rabatt'
              ].map((f, i) => (
