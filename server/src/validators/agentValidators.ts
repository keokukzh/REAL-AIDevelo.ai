...
export const BusinessProfileSchema = z.object({
  ...
  website: z
    .union([z.string().url('Invalid website URL'), z.string().length(0), z.undefined()])
    .optional(),
  location: z.object({
  ...
  contact: z.object({
    ...
    email: z
      .preprocess(
        ...
        z.union([z.string().email('Invalid email address'), z.string().length(0), z.undefined()]),
      )
      .optional(),
  }),
  ...
  voiceSettings: z
    .object({
      voiceId: z
        ...
        .max(100, 'Invalid voice ID format')
        .default('de-CH-LeniNeural'),
      modelId: z.string().optional().default('azure-tts'),
    })
    .optional()
    .default({
