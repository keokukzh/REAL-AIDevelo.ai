...
export const OnboardingPage = () => {
    ...
    const handleCreateAgent = async (finalData: any) => {
        ...
        try {
            ...
            fetch('http://127.0.0.1:7242/ingest/30ee3678-5abc-4df4-b37b-e571a3b256e0',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({location:'OnboardingPage.tsx:97',message:'Creating agent - auth state',data:{hasToken:!!authToken,tokenLength:authToken?.length,payloadSize:JSON.stringify(payload).length},timestamp:Date.now(),sessionId:'debug-session',hypothesisId:'A'})}).catch(()=>{});
            // #endregion
