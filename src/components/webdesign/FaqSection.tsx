      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto font-light">
            Alles, was Sie über unsere Webdesign-Prozesse und Technologien wissen müssen.
          </p>
        </div>
          ...
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                ...
                <ChevronDown 
                  size={20} 
                  className={`text-gray-500 transition-transform duration-300 ${openIndex === index ? 'rotate-180 text-blue-500' : ''}`}
                  aria-hidden="true"
                />
              </button>
