    ...
    return (
        <group>
             {Array.from({ length: 5 }).map((_, i) => (
                <Float key={i} speed={1 + i * 0.2} rotationIntensity={0.2} floatIntensity={0.5} position={[0, i - 2, 0]}>
...
const UltraScene = () => {
  return (
    <>
      ...
      <Sparkles count={500} scale={15} size={3} speed={0.4} opacity={0.5} color="#00ff99" />
      <Sparkles count={300} scale={10} size={2} speed={0.8} opacity={0.3} color="#ff0055" />
    </>
  );
};
